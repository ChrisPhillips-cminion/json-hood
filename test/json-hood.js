...
describe("assertions", {
	...
	var resp = arrowDiagram.getJSONasArrowDiagram({"Table":[
    {"name":"Plate", "Colour":"White"},
    {"name":"Fork", "Colour":"Pink"},
    {"name":"Knife", "Colour":"Blue"},
    {"name":"Spoon", "Colour":"Green"}
]});
  this.expect('Table\n'+
'├────> [0]\n'+
'│	├────>name :  Plate\n'+
...
'└────> [3]\n'+
' 	├────>name :  Spoon\n'+
' 	└────>Colour :  Green',resp.trim());
    }
}, { callbackMode: 'node' });
describe.getResults( function (results) {
	console.log(results);
} );
/*
